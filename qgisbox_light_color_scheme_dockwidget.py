...
"""
/***************************************************************************
 QgsBoxLightColorSchemeDockWidget
                                 A QGIS plugin
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'qgisbox_light_color_scheme_dockwidget_base.ui'))


class QgsBoxLightColorSchemeDockWidget(QtWidgets.QDockWidget, FORM_CLASS):

    closingPlugin = pyqtSignal()

    def __init__(self, parent=None, iface=None):
        """Constructor."""
        super(QgsBoxLightColorSchemeDockWidget, self).__init__(parent)
